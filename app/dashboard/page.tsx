    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl p-5">
          ...
          <div className="text-xs text-[#7d7a70] font-semibold mt-1">Orders this month</div>
        </div>
        <div className="bg-white rounded-2xl p-5">
          <div className="font-display text-2xl font-black text-primary">Rs. 0</div>
          <div className="text-xs text-[#7d7a70] font-semibold mt-1">Revenue this month</div>
        </div>
        <div className="bg-white rounded-2xl p-5">
          <div className="font-display text-2xl font-black text-primary">0</div>
